...
parser.add_argument('-f', action='store', dest='frames', default='1440', help='number of frames to capture. default is 1440')
parser.add_argument('-i', action='store', dest='interval', default='5', help='interval to wait between frames in seconds. default is 5s')
